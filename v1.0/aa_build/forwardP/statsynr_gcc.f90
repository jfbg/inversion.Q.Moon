...
!
! $Revision: 1150 $
! $Date: 2014-10-29 11:53:28 +0100 (Wed, 29 Oct 2014) $
! $Author: jguertin $
!
!
!
...
!      ^^^^^ DECLARATIONS ^^^^^
      ...
      WRITE(*,*) 'Last Edited on $Date: 2014-10-29 11:53:28 +0100 (Wed, 29 Oct 2014) $'
...
!
      ...
      !Pick conversion
       ...
       !CO2
!       WRITE(6,*) 'RTCOEF_PSV ',rtp,rts,rrp,rrs
